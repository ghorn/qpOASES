 ...
 *	"Example 02" from from http://www.qpOASES.org/onlineQP/ and store it
 *into the directory bin/chain80w/.
 */
...
int main() {
  ...
  /* 2) Run benchmark. */
  if (runOqpBenchmark("./chain80w/", isSparse, options, nWSR, maxCPUtime,
                      maxStationarity, maxFeasibility,
                      maxComplementarity) != SUCCESSFUL_RETURN) {
    myPrintf("In order to run this example, you need to download example no. "
