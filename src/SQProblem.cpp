...
returnValue SQProblem::hotstart(SymmetricMatrix *H_new, const real_t *const g_new, Matrix *A_new,
  ...
  returnValue returnvalue = QProblem::hotstart(g_new, lb_new, ub_new, lbA_new, ubA_new, nWSR,
 ...
 *	h o t s t a r t
 */
returnValue SQProblem::hotstart(const real_t *const H_new, const real_t *const g_new,
 ...
 *	h o t s t a r t
 */
returnValue SQProblem::hotstart(const char *const H_file, const char *const g_file,
 ...
 *	h o t s t a r t
 */
returnValue SQProblem::hotstart(const real_t *const g_new, const real_t *const lb_new,
                                const real_t *const ub_new, const real_t *const lbA_new,
                                const real_t *const ubA_new, int_t &nWSR, real_t *const cputime,
                                const Bounds *const guessedBounds,
                                const Constraints *const guessedConstraints) {
  /* Call to hotstart function for fixed QP matrices. */
  return QProblem::hotstart(g_new, lb_new, ub_new, lbA_new, ubA_new, nWSR, cputime, guessedBounds,
                            guessedConstraints);
}
 ...
 *	h o t s t a r t
 */
returnValue SQProblem::hotstart(const char *const g_file, const char *const lb_file,
                                const char *const ub_file, const char *const lbA_file,
                                const char *const ubA_file, int_t &nWSR, real_t *const cputime,
                                const Bounds *const guessedBounds,
                                const Constraints *const guessedConstraints) {
...
returnValue SQProblem::setupNewAuxiliaryQP(SymmetricMatrix *H_new, Matrix *A_new,
  ...
  for (n_try = 0; n_try < 2; ++n_try) {
    ...
    for (int_t ii = 0; ii < nV; ++ii) {
      if (oldBounds.getType(ii) == ST_EQUALITY && bounds.getType(ii) == ST_BOUNDED) {
