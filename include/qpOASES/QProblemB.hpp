...
protected:
  ...
  BooleanType isCPUtimeLimitExceeded(
      const real_t
          *const cputime, /**< Maximum CPU time allowed for QP solution. */
  ...
  returnValue performRatioTest(
      ...
      const SubjectTo
          *const subjectTo, /**< Bound/Constraint object corresponding to ratios
                               to be checked. */
  ...
  isBlocking(real_t num,    /**< Numerator for performing the ratio test. */
             ...
             real_t &t      /**< Input: Current maximum step length along the
                             * homotopy path,      Output: Updated maximum possible step
                             * length along the homotopy path. */
             ) const;
