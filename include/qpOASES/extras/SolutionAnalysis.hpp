 ...
 public:
  ...
  returnValue getVarianceCovariance(
      ...
      const real_t *const g_b_bA_VAR, /**< Input:  Variance-covariance of g, the bounds lb and ub,
                                       *			 and lbA and ubA respectively.
                                       *Dimension: 2nV x 2nV */
      real_t *const Primal_Dual_VAR /**< Output: The result for the variance-covariance of the
                                     *primal and dual variables. Dimension: 2nV x 2nV */
      ) const;
  ...
  returnValue getVarianceCovariance(
      ...
      real_t *const Primal_Dual_VAR /**< Output: The result for the variance-covariance of the
                                     *primal and dual variables. Dimension:  (2nV+nC) x (2nV+nC) */
      ) const;
  ...
  /** Checks if a direction of negative curvature shows up if we remove all bounds that just
