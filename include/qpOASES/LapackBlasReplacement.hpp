...
void DGEMM(const char *, const char *, const la_uint_t *, const la_uint_t *,
...
void SGEMM(const char *, const char *, const la_uint_t *, const la_uint_t *,
...
void DPOTRF(const char *, const la_uint_t *, double *, const la_uint_t *,
            la_int_t *);
/** Calculates the Cholesky factorization of a real symmetric positive definite
 * matrix in single precision. */
void SPOTRF(const char *, const la_uint_t *, float *, const la_uint_t *,
            la_int_t *);
