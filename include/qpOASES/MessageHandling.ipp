 ...
 */
inline FILE *MessageHandling::getOutputFile() const { return outputFile; }

/*
 *	g e t E r r o r C o u n t
 */
inline int_t MessageHandling::getErrorCount() const { return errorCount; }

/*
 *	s e t E r r o r V i s i b i l i t y S t a t u s
 */
inline void
MessageHandling::setErrorVisibilityStatus(VisibilityStatus _errorVisibility) {
 ...
 */
inline void MessageHandling::setWarningVisibilityStatus(
 ...
 */
inline void
MessageHandling::setInfoVisibilityStatus(VisibilityStatus _infoVisibility) {
