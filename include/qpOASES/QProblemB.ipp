 ...
 *	g e t N V
 */
inline int_t QProblemB::getNV() const { return bounds.getNV(); }

/*
 *	g e t N F R
 */
inline int_t QProblemB::getNFR() const { return bounds.getNFR(); }

/*
 *	g e t N F X
 */
inline int_t QProblemB::getNFX() const { return bounds.getNFX(); }

/*
 *	g e t N F V
 */
inline int_t QProblemB::getNFV() const { return bounds.getNFV(); }
 ...
 */
inline BooleanType QProblemB::isInfeasible() const { return infeasible; }

/*
 *	i s U n b o u n d e d
 */
inline BooleanType QProblemB::isUnbounded() const { return unbounded; }
 ...
 *	g e t O p t i o n s
 */
inline Options QProblemB::getOptions() const { return options; }
 ...
 *	g e t C o u n t
 */
inline uint_t QProblemB::getCount() const { return count; }
 ...
 */
inline void QProblemB::applyGivens(real_t c, real_t s, real_t nu, real_t xold,
                                   real_t yold, real_t &xnew,
                                   real_t &ynew) const {
 ...
 * i s B l o c k i n g
 */
inline BooleanType QProblemB::isBlocking(real_t num, real_t den, real_t epsNum,
                                         real_t epsDen, real_t &t) const {
