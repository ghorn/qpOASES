 ...
 *	g e t N C
 */
inline int_t QProblem::getNC() const { return constraints.getNC(); }

/*
 *	g e t N E C
 */
inline int_t QProblem::getNEC() const { return constraints.getNEC(); }

/*
 *	g e t N A C
 */
inline int_t QProblem::getNAC() const { return constraints.getNAC(); }

/*
 *	g e t N I A C
 */
inline int_t QProblem::getNIAC() const { return constraints.getNIAC(); }
