 ...
 *	designed to manage working sets of constraints and bounds within a
 *QProblem.
 */
 ...
 *	s e t N o L o w e r
 */
inline void SubjectTo::setNoLower(BooleanType _status) { noLower = _status; }

/*
 *	s e t N o U p p e r
 */
inline void SubjectTo::setNoUpper(BooleanType _status) { noUpper = _status; }

/*
 *	h a s N o L o w e r
 */
inline BooleanType SubjectTo::hasNoLower() const { return noLower; }

/*
 *	h a s N o U p p p e r
 */
inline BooleanType SubjectTo::hasNoUpper() const { return noUpper; }
