...
int_t qpOASES_obtainOutputs(const QProblemB *const globalQpObject,
                            returnValue returnvalue, real_t *const x,
                            real_t *const y, real_t *const obj,
                            int_t *const status) {
  if (globalQpObject == 0)
    return -1;
 ...
 */
int_t QProblem_init(const real_t *const H, const real_t *const g,
                    const real_t *const A, const real_t *const lb,
                    const real_t *const ub, const real_t *const lbA,
                    const real_t *const ubA, int_t *const nWSR,
                    real_t *const cputime, const qpOASES_Options *const options,
                    real_t *const x, real_t *const y, real_t *const obj,
                    int_t *const status) {
  ...
  returnValue returnvalue =
      globalQProblemObject->init(H, g, A, lb, ub, lbA, ubA, *nWSR, cputime);

  /* assign lhs arguments */
  return qpOASES_obtainOutputs(globalQProblemObject, returnvalue, x, y, obj,
                               status);
}
 ...
 */
int_t QProblem_hotstart(const real_t *const g, const real_t *const lb,
                        const real_t *const ub, const real_t *const lbA,
                        const real_t *const ubA, int_t *const nWSR,
                        real_t *const cputime, real_t *const x, real_t *const y,
                        real_t *const obj, int_t *const status) {
  /* abort if QProblem_setup has not been called */
  if (globalQProblemObject == 0)
    return -1;
  ...
  /* actually call solver */
  returnValue returnvalue =
      globalQProblemObject->hotstart(g, lb, ub, lbA, ubA, *nWSR, cputime);
 ...
 */
int_t QProblemB_init(const real_t *const H, const real_t *const g,
                     const real_t *const lb, const real_t *const ub,
                     int_t *const nWSR, real_t *const cputime,
                     const qpOASES_Options *const options, real_t *const x,
                     real_t *const y, real_t *const obj, int_t *const status) {
  ...
  /* actually call solver */
  returnValue returnvalue =
      globalQProblemBObject->init(H, g, lb, ub, *nWSR, cputime);

  /* assign lhs arguments */
  return qpOASES_obtainOutputs(globalQProblemBObject, returnvalue, x, y, obj,
                               status);
}
 ...
 */
int_t QProblemB_hotstart(const real_t *const g, const real_t *const lb,
                         const real_t *const ub, int_t *const nWSR,
                         real_t *const cputime, real_t *const x,
                         real_t *const y, real_t *const obj,
                         int_t *const status) {
  /* abort if QProblemB_setup has not been called */
  if (globalQProblemBObject == 0)
  ...
  /* actually call solver */
  returnValue returnvalue =
      globalQProblemBObject->hotstart(g, lb, ub, *nWSR, cputime);
 ...
 */
int_t SQProblem_init(const real_t *const H, const real_t *const g,
                     const real_t *const A, const real_t *const lb,
                     const real_t *const ub, const real_t *const lbA,
                     const real_t *const ubA, int_t *const nWSR,
  ...
  /* actually call solver */
  returnValue returnvalue =
      globalSQProblemObject->init(H, g, A, lb, ub, lbA, ubA, *nWSR, cputime);

  /* assign lhs arguments */
  return qpOASES_obtainOutputs(globalSQProblemObject, returnvalue, x, y, obj,
                               status);
}
 ...
 */
int_t SQProblem_hotstart(const real_t *const H, const real_t *const g,
                         const real_t *const A, const real_t *const lb,
                         const real_t *const ub, const real_t *const lbA,
                         const real_t *const ubA, int_t *const nWSR,
                         real_t *const cputime, real_t *const x,
  ...
  /* actually call solver */
  returnValue returnvalue = globalSQProblemObject->hotstart(
      H, g, A, lb, ub, lbA, ubA, *nWSR, cputime);
